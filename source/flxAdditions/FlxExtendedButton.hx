 ...
 */
class FlxExtendedButton extends FlxSpriteGroup
{
	...
	public function new(X:Float = 0, Y:Float = 0, ?Callback:Void->Void, ?Label:String, Width:Int = 100, Height:Int = 20)
	{
		...
		if (Label != null)
		{
			...
			textNormal.setFormat(AssetPaths.FntDefault, 8, 0xffffff, "center");
			
			textHighlight = new FlxText(0, 3, Width, Label);
			textHighlight.setFormat(AssetPaths.FntDefault, 8, 0xffffff, "center");
